...
{
    partial class ColumnFinishForm
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.label1.Text = "Пожалуйста, выберите тип стены для создания штукатурки.";
            // 
            // comboBox1
            // 
            ...
            this.label2.Text = "Внимание, штукатурка сгенерируется только для колонн,";
            // 
            // label3
            // 
            ...
            this.label3.Text = "которые находятся в помещении!";
            // 
            // button2
            // 
            this.button2.Font = new System.Drawing.Font("Microsoft Sans Serif", 12F);
            this.button2.Location = new System.Drawing.Point(361, 107);
            ...
            this.Name = "ColumnFinishForm";
            this.ShowIcon = false;
            this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
            this.Text = "Отделка колонн";
            this.Load += new System.EventHandler(this.ColumnFinishForm_Load_1);
